            ...
            <div>
                ...
                { 
                    ...
                    <div className="col-12">
                        ...
                        Results are evaluated succesfully. You can <b>click Download button</b> to see Churn Analysis of the data u uploaded.
                        </div>
                    ...
                    <div className="col-6">
                        ...
                        {this.state.executed === false && 
                        <div className= {styles.paragraph}>
                            Churn analysis is used to check which customers are likely to remain loyal and which are not. This gives the ecommerce store owner the opportunity to improve himself beforehand so that the churn rate can be decreased which has the potential to retain and increase sales in the coming months. The underlying algorithm being used here is binary logistic regression using the XGBoost module which speeds up the process of creating a good model.
